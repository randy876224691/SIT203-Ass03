       	...
       	<div class="left_content">
            ...
            <p class="details">
                ...
                <div class="form_subtitle">create new account</div>
                 <form name="register" action="registerS.php" onSubmit="return CheckForm()" method="POST">   
                    ...
                    <input type="text" class="contact_input" name="email" onblur="check_email(this)" class="required email" required/><span id="show_e" style="color:red;">
                    </div>
                    ...
                    <div class="form_row">
                        ...
                        I agree to the <a href="register.php">terms &amp; conditions</a>                        
						</div>
                    </div> 
