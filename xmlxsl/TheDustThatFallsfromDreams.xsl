  ...
  <xsl:template match = "/">
    ...
    <html xmlns = "http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <xsl:for-each select="category/book[@name='TheDustThatFallsfromDreams']">
            ...
            <div class="feat_prod_box_details">
              ...
              <div class="prod_det_box">
                ...
                <div class="box_center">
                  ...
                  <a href="#" class="more" onclick="window.open('order.html?transdata='+'TheDustThatFallsfromDreams')">
